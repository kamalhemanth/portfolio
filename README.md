...
## Education							       		
- M.S., Data SCeince	| The University of Texas at Arlington (_December 2023_)	 			        		
- B.Tec., Computer Science | Sree Venkateswara College Of Engineering, Andhra Pradesh, India (_April 2019_)
...
The Real-Time Face and Eyes Detection project uses OpenCV in Python to detect human faces and eyes from a webcam feed in real time. It employs Haar cascade classifiers for face and eye detection, highlighting the detected areas with rectangles.
